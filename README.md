...
- Accelerated PPO variants: benchmarking stability and sample efficiency 
- Offline RL for autonomous driving: online expert (TQC + gSDE)
  to offline policies (CQL), studying deliberate vs habitual control
- Federated learning for medical imaging: privacy-preserving framework, 
  validated on chest X-ray pathology classification

## Stack I reach for

`PyTorch` `Stable-Baselines3` `Gymnasium / MuJoCo` `HuggingFace` 
`FastAPI` `Docker` `CUDA` `W&B`

## Find me

[LinkedIn](https://linkedin.com/in/hajar-doukhou) · 
[hajar.doukhou@outlook.com](mailto:hajar.doukhou@outlook.com)
